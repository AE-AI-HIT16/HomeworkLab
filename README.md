...
- 🗄️ **Google Sheets as Database**: Kết nối với Google Sheets để lưu cấu trúc sinh viên, điểm số, và tiến độ nộp bài (Upsert real-time). Tiện lợi cho giáo viên xuất Excel.
