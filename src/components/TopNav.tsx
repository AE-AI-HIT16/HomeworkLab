...
export function TopNav({ user, role, showSearch = false }: TopNavProps) {
    ...
    const linkClass = (path: string) =>
        isActive(path)
            ...
            : "text-[var(--hw-on-surface-variant)] hover:text-[var(--hw-on-surface)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--hw-primary)] focus-visible:ring-offset-2 rounded-sm";
    ...
    return (
        <nav aria-label="Top navigation" className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md shadow-sm h-16 flex items-center justify-between px-6">
            <div className="flex items-center gap-8">
                {/* Unified Branding */}
                <Link
                    href={dashboardLink}
                    className="flex items-center gap-2 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--hw-primary)] focus-visible:ring-offset-2 rounded-md"
                >
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative group inline-flex items-center">
                    ...
                    <div
                        ...
                        className="absolute right-0 top-10 mt-2 w-52 bg-white border border-slate-100 shadow-xl rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible group-focus-within:opacity-100 group-focus-within:visible transition-all flex flex-col p-2 z-[60]"
                    >
